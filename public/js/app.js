...
/***/ "./resources/js/alpine/data/product.js":
/*!*********************************************!*\
  !*** ./resources/js/alpine/data/product.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/alpine/store/cart.js":
/*!*******************************************!*\
  !*** ./resources/js/alpine/store/cart.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].store('cart', {
  count: app.cartCount,
...
/***/ "./resources/js/alpine/store/products.js":
/*!***********************************************!*\
  !*** ./resources/js/alpine/store/products.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].store('products', {
    ...
    this.filterElements.forEach(function (filterEl) {
      filterEl.addEventListener('optionChange', function (e) {
        if (filterEl.getAttribute('data-type') === 'checkbox' && !filterEl.querySelectorAll('input:checked').length) {
          _this.affectedFilters = _this.affectedFilters.filter(function (item) {
            return item !== filterEl;
          });
          return;
        }

        if (!_this.affectedFilters.includes(filterEl)) {
          _this.affectedFilters.push(filterEl);
        }
      });
    });
    elements.forEach(function (el) {
      el.addEventListener('change', function (e) {
        return e.target.dispatchEvent(optionChange);
      });
    });
  },
    ...
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              url = _arguments.length > 0 && _arguments[0] !== undefined ? _arguments[0] : window.location.href;
  ...
  resetFilters: function resetFilters() {
    this.affectedFilters.forEach(function (el) {
      var type = el.getAttribute('data-type');

      if (type === 'checkbox') {
        el.querySelectorAll('input[type="checkbox"]').forEach(function (e) {
          e.checked = false;
        });
      }

      if (type === 'between') {
        var min = el.querySelector('input[name="min"]').getAttribute('min'),
  ...
  applyFilters: function applyFilters() {
    ...
    this.affectedFilters.forEach(function (el) {
      ...
      if (data.type === 'checkbox') {
        ...
        checked.forEach(function (checkedEl) {
          data.values.push(checkedEl.getAttribute('data-value'));
        });
      }

      if (data.type === 'between') {
        var min = el.querySelector('input[name="min"]'),
